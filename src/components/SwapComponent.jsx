...
export default function SwapComponent(props) {
  const [coin, setCoin] = useState(["CARBON", "USDT"]);
  ...
  return (
    <div className="tabBody">
      ...
      <BoxTemplate
        ...
        balance={
          props.holding[
          "amountOfCARBON".includes(coin[0]) ? "amountOfCARBON" : "amountOfUSDT"
          ]
        }
      ...
      <BoxTemplate
        ...
        balance={
          props.holding[
          "amountOfCARBON".includes(coin[1]) ? "amountOfCARBON" : "amountOfUSDT"
          ]
        }
