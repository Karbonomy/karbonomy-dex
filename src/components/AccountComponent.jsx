            ...
            <>
              ...
              <div className="Assets">
                ...
                <div className="assetBody">
                  <div className="row">
                    <div className="attributeName">Amount of CARBON</div>
                    <div className="attributeValue">
                      {props.holding["amountOfKAR"]}
                    </div>
                  </div>
                  <div className="row">
                    <div className="attributeName">Amount of USDT</div>
                    <div className="attributeValue">
              ...
              <div className="Assets">
                ...
                <div className="assetBody">
                  <div className="row">
                    <div className="attributeName">Total CARBON</div>
                    <div className="attributeValue">
                      {props.holding["totalKAR"]}
                    </div>
                  </div>
                  <div className="row">
                    <div className="attributeName">Total USDT</div>
                    <div className="attributeValue">
